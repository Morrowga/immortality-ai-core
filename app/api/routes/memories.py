...
def _serialize_memory_short(m: Memory) -> dict:
    return {
        "id":                  str(m.id),
        "section":             m.section,
        "what_happened":       m.what_happened_original or m.what_happened, 
        "how_i_felt":          m.how_i_felt_original or m.how_i_felt,      
        "why_it_mattered":     m.why_it_mattered_original or m.why_it_mattered,
        "what_i_learned":      m.what_i_learned_original or m.what_i_learned,
        "instinct_formed":     m.instinct_formed_original or m.instinct_formed,
